//
//  DemoWattpadViewController.swift
//  OCTestCoreFramework
//
//  Created by wtfan on 2017/12/6.
...
class DemoWattpadViewController: UIViewController, WtWattpadViewDelegate, WtWattpadViewDatasource{
